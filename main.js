...
function updateHeaderUserPhoto() {
    ...
    if (headerUsernameElement) {
        headerUsernameElement.textContent = currentUser;
    }
    updateUserPhoto();
}

function updateUserPhoto() {
    const headerUserPhotoElement = document.getElementById('header-user-photo');
    let photoUrl = 'https://i.postimg.cc/ZqzFYh0r/v4-460px-Delete-a-User-Account-Picture-in-Windows-10-Step-14-jpg-removebg-preview.png'; // Default photo URL

    if (currentUser.toLowerCase() === 'hemant') {
        photoUrl = 'https://i.postimg.cc/ZqzFYh0r/v4-460px-Delete-a-User-Account-Picture-in-Windows-10-Step-14-jpg-removebg-preview.png';
    }

    if (headerUserPhotoElement) {
        headerUserPhotoElement.src = photoUrl;
    }
}
